...
namespace ImGui
{
    ...
    IMGUI_API bool          JoysticWidget(const char* label, ImVec2 size, float grabRadius, float* x, float* y, ImVec2 minBound, ImVec2 maxBound, bool en_x = true, bool en_y = true);
